...
namespace 电子族谱管理系统.DAL
{
    ...
    public class UserDAL
    {
        ...
        public int Add(电子族谱管理系统.Model.User model)
        {
            ...
            strSql.Append("[User_id], [User_name], [User_pwd], [User_sex], [User_birth], [User_death], [User_wid], [User_fid], [User_no], [Gen_id] )");
        ...
        public bool Update(电子族谱管理系统.Model.User model)
        {
            ...
            strSql.Append("[User_id]=@User_id, [User_name]=@User_name, [User_pwd]=@User_pwd, [User_sex]=@User_sex, [User_birth]=@User_birth, [User_death]=@User_death, [User_wid]=@User_wid, [User_fid]=@User_fid, [User_no]=@User_no, [Gen_id]=@Gen_id   ");
